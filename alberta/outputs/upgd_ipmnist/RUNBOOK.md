...
validation passes, but it remains permanently nonpromoting. The receipt
`nonpromoting_receipt.v1.json` binds both artifacts, all 20 shards, the
reconstructed source partitions and cache, exact summary values, limitations,
and the operational log archive.
