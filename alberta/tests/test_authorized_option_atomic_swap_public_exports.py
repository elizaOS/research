"""Public-package identity contracts for authorized option atomic swap."""

import pytest

import alberta_framework as alberta
import alberta_framework.core as core
from alberta_framework.core import authorized_option_atomic_swap as implementation

pytestmark = pytest.mark.unit


def test_root_and_core_export_exact_declared_atomic_swap_surface() -> None:
