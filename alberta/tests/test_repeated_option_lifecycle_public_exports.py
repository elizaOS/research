"""Public-package identity contracts for the repeated option lifecycle."""

import pytest

import alberta_framework as alberta
import alberta_framework.core as core
from alberta_framework.core import repeated_option_lifecycle as implementation

pytestmark = pytest.mark.unit


def test_root_and_core_export_exact_declared_repeated_lifecycle_surface() -> None:
