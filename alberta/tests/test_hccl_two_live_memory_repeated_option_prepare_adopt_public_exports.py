"""Public identity contracts for the no-planner repeated-option composite."""
...
from alberta_framework.core import (
    hccl_two_live_memory_repeated_option_prepare_adopt_bridge as implementation,
)

pytestmark = pytest.mark.unit


def test_root_and_core_export_exact_declared_composite_surface() -> None:
